...
- Below, apply recommended `.tsv` file extension for tab-separated tables, and rename unequivocally first `colname` into `barcode_id`:
...
- List of changes applied for better data management:
...
## data/Table of compounds_stringent_2025-06-13.xlsx
