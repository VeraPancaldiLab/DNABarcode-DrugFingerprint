...
- [Average over replicates.]{fg="blue"} 
...
saveRDS(se_compound_by_batch_discretised,
        file = paste0("./results/compounds/se_discretised_per_compound_by_batch",
                      today_date, ".rds"))
...
barcode_discretised_replicates_mat <- barcode_discretised_replicates_replicates |> 
  tibble::column_to_rownames(var="barcode_id") |> 
  as.matrix()
cor_replicates <- cor(barcode_discretised_replicates_mat)


barcode_discretised_compounds_mat <- barcode_discretised_replicates_compound |> 
  tibble::column_to_rownames(var="barcode_id") |> 
  as.matrix()
