...
# Define clustering colours
col_cor_scale <- circlize::colorRamp2(c(min(cor_per_compound_by_batch), 0, 1),
                                      c("blue", "white", "red"))
...
# Define clustering colours
col_cor_scale <- circlize::colorRamp2(c(min(cor_per_compound), 0, 1),
                                      c("blue", "white", "red"))
...
# Define clustering colours
col_cor_scale <- circlize::colorRamp2(c(min(cor_per_replicates), 0, 1),
                                      c("blue", "white", "red"))
...
# 4) export PNG and readble graph formats for Neo4J
